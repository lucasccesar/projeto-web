...
function updateStatusCounters() {
    document.querySelector('[data-status="LENDO"]').textContent =
        `Lendo agora (${filterByStatus("LENDO").length})`

    document.querySelector('[data-status="LIDO"]').textContent =
        `Já li (${filterByStatus("LIDO").length})`

    document.querySelector('[data-status="QUERO_LER"]').textContent =
        `Quero ler (${filterByStatus("QUERO_LER").length})`
}
